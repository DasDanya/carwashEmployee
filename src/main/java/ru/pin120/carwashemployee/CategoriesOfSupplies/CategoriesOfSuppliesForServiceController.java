...
/**
 *  онтроллер прив€зки категорий расходных материалов к услуге
 */
public class CategoriesOfSuppliesForServiceController implements Initializable {
    ...
    /**
     * Ќастраивает форму дл€ отображени€ информации о прив€зки категорий расходных материалов к услуге.
     * ”станавливает заголовок окна на основе названи€ услуги, заполн€ет таблицу с прив€зками
     * @param service ”слуга, дл€ которой будет устанавливатьс€ прив€зка
     * @param stage   ќкно JavaFX, на котором будет отображатьс€ форма
     */
    ...
    /**
     * «аполн€ет таблицу с прив€зками категорий расходных материалов к услуге
     */
