...
/**
 *  онтроллер формы с категори€ми и услугами автомойки
 */
public class CategoriesAndServicesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        rb = resourceBundle;
        //прив€зываем ширину столбцов к ширине таблицы
        ...
        // ”станавливаем заголовки дл€ таблиц
    ...
    /**
     * »нициализирует списки, используемые дл€ заполнени€ ObservableLists.
     */
...
//    }
    ...
    /**
     * «аполн€ет ObservableList услугами по имени категории.
     *
     * @param categoryName им€ категории
    ...
    /**
     * ƒобавл€ет слушатель выбранной категории
     */
...
//                    }
    ...
    /**
     * ќтслеживает фокус на таблицах категорий и услуг.
     */
...
//        });
    ...
    /**
     * ¬ыполн€ет операции с категорией или с услугой.
     * ¬ыполнение операции зависит от таблицы, котора€ находитьс€ в фокусе
     * @param mode –ежим операции
     */
    private void doOperation(FXOperationMode mode){
        if(!AppHelper.getUserInfo().get(2).equals(UserRole.OWNER.name())){
            ...
            lastSelectedTable.requestFocus();
        }else {
    ...
    /**
     * ќбрабатывает результаты операций с категорией (создание, удаление).
     * @param operationMode режим операции (создание, удаление)
     * @param exitMode режим выхода из формы
     * @param categoryOfServices  атегори€
     * @param selectedCategoryOfServicesFX выбранна€ категори€ CategoryOfServicesFX дл€ удалени€
     */
            ...
            switch (operationMode) {
                case CREATE:
                    //if(lastSearchedCategory.isEmpty() || categoryOfServices.getCatName().toLowerCase().contains(lastSearchedCategory.toLowerCase())) {
                        categoryOfServices.setServices(new ArrayList<>()); // чтобы не ругалс€ на пустой список
...
//                    break;
    ...
    /**
     * ќбрабатывает результаты операций с услугой (создание, удаление).
     *
     * @param operationMode режим операции (создание, удаление)
     * @param exitMode режим выхода из формы
     * @param serviceDTO объект ServiceDTO, содержащий информацию об услуге
     * @param selectedServiceFX выбранна€ услуга ServiceFX дл€ удалени€
     */
...
//                        }
    ...
    /**
     * ќчищает ObservableList категорий и услуг
     */
    ...
    /**
     * ќчищает текстовое поле дл€ поиска и обновл€ет данные в таблицах
     */
